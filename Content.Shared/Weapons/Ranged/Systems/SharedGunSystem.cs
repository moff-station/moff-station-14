...
public abstract partial class SharedGunSystem : EntitySystem
{
    ...
    private bool AttemptShoot(EntityUid user, Entity<GunComponent> gun)
    {
        ...
        var gunShakeTranslation = new ESScreenshakeParameters() { Trauma = 0.25f * gun.Comp.CameraRecoilScalarModified, DecayRate = 10.0f, Frequency = 0.008f, Direction = shotDirection};
