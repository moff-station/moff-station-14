...
namespace Content.IntegrationTests.Tests
{
    ...
    public sealed class PostMapInitTest
    {
        ...
        private static readonly Dictionary<string, HashSet<EntProtoId>> DoNotMapWhitelistSpecific = new()
        {
            ...
            {"/Maps/_Moffstation/Shuttles/shuttle-nt-gunboat-light.yml", ["ShuttleGunDuster", "ShuttleGunPerforator"]},
            {"/Maps/_Moffstation/Shuttles/shuttle-nt-gunboat-heavy.yml", ["ShuttleGunDuster"]},
            {"/Maps/_Moffstation/PreCrewed/shuttle-nt-gunboat-light.yml", ["ShuttleGunDuster", "ShuttleGunPerforator"]},
            {"/Maps/_Moffstation/PreCrewed/shuttle-nt-gunboat-heavy.yml", ["ShuttleGunDuster"]},
