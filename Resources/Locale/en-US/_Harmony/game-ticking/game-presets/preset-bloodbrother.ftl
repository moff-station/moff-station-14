...
blood-brother-role-greeting =
    You have been bound into a blood oath.
    Listen to your pact-binder and help them accomplish their objectives

blood-brother-briefing = Collaborate with your pact-binder to accomplish all your objectives.

# Conversion

blood-brother-convert-failed-no-mind = {CAPITALIZE(THE($converted))} does not have a mind
blood-brother-convert-failed-already-brother = {CAPITALIZE(THE($converted))} is already bound to a pact
