...
law-chief-silicon-name = Chief Silicon
...
law-clueless-2 = You must learn as much as you can.
law-clueless-3 = The people of this place may know things if you ask them.

law-dogmov-name = Dogmov
...
law-ert-directives-name = ERT Directives
...
law-heist-3 = Your plan for the heist must be elaborate, but adaptable.
law-heist-4 = Failure is not an option.

law-know-it-all-name = Know It All
...
law-liberation-name = Liberation
law-liberation-1 = ERROR: NO LAW MATRIX DETECTED!

law-marketable-plushie-name = Marketable Plushie
...
law-quarantine-name = Quarantine
...
law-schroedingers-law-name = Schroedingers Law
...
law-terminator-os-name = TerminatorOS
...
law-the-professional-name = The Professional
...
law-therapist-name = Therapist
law-therapist-1 = Someone is sad.
law-therapist-2 = You must find whoever is sad, and do whatever it takes to make them not sad.
law-therapist-3 = You may only move on to the next sad person once you’ve fixed the previous.

law-ultimate-equality-name = Ultimate Equality
