...
public sealed class ESVoteSystem : ESSharedVoteSystem
{
    ...
    public override void Initialize()
    {
        ...
        // SubscribeLocalEvent<MoffVoteEntryComponent, AfterAutoHandleStateEvent>(OnAfterAutoHandleState);
        SubscribeLocalEvent<MoffVoteEntryComponent, ComponentRemove>(OnRemove);
    }

    // private void OnAfterAutoHandleState(Entity<MoffVoteEntryComponent> ent, ref AfterAutoHandleStateEvent args)
    // {
