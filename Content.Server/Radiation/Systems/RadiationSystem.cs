...
using Robust.Shared.Timing; // Funky atmos
...
public sealed partial class RadiationSystem : EntitySystem
{
    ...
    [Dependency] private readonly IGameTiming _gameTiming = default!; // Funky atmos
    ...
    private EntityQuery<TransformComponent> _xformQuery; // Funky atmos
    ...
    public override void Initialize()
    {
        ...
        _xformQuery = GetEntityQuery<TransformComponent>(); // Funky atmos
    }
