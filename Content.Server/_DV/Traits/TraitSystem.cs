...
public sealed partial class TraitSystem : EntitySystem
{
    ...
    private void OnPlayerSpawnComplete(PlayerSpawnCompleteEvent args)
    {
        ...
        if (TryComp<InventoryComponent>(args.Mob, out var humanoid))
            speciesId = humanoid.SpeciesId;
    ...
    /// </summary>
    public void ApplyTrait(EntityUid player, TraitPrototype trait) // Moffstation - Make public
    {
